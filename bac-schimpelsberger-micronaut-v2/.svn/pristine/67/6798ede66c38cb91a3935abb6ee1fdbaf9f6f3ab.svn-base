...
public class UserController {
	...
	protected final DefaultSecurityService securityService;
	
		public UserController(UserService service, DefaultSecurityService securityService) { 
		...
		private void logAuthentication() {
			...
			if (auth==null) {
				...
				Object roles=auth.getAttributes().get("roles");
				log.info("Authentication for user: {} has roles: {}",name,roles.toString());
			}
		}
